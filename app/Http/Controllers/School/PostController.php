...
class PostController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('school.posts.posts')->with('posts', $posts);
    }

    public function create()
    {
        //
        return view('school.posts.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $contact->save();
        return redirect('/sa/posts')->with('success', 'Post saved!');
    }

    public function edit($id)
    {
        $post = Post::find($id);
        return view('school.posts.edit', compact('post'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!is_null($contact)) {
            ...
            $contact->save();
            return redirect('/sa/posts')->with('success', 'Post updated!');
        } else {
            return redirect('/sa/posts')->with('fail', 'Post Not Found!');
        }
    ...
    public function destroy($id)
    {
        ...
        if (!is_null($contact)) {
            $contact->delete();
            return redirect('/sa/posts')->with('success', 'Record deleted!');
        }
        return redirect('/sa/posts')->with('fail', 'Not Found');
    }
