                ...
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        ...
                        <a style="float: right;" class="ml-auto btn btn-sm btn-info mr-4"
                            href="{{ url('sa/post/create') }}">Add Post</a>
                    </div>
                        ...
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col" class="sort" data-sort="commnets">Comments</th>
                                    <th scope="col"></th>
                                </tr>
                            </thead>
                            <tbody class="list">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <a class="dropdown-item"
                                                        href="{{ route('school_post_edit', $post->id) }}">Edit</a>

                                                    <form onsubmit="return window.confirm('are you sure to delete?');"
                                                        action="{{ route('school_post_delete', $post->id) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
