            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        <h3 style="display: inline-block;" class="mb-0">All Posts</h3>

                        <a style="float: right;" class="ml-auto btn btn-sm btn-info mr-4"
                            href="{{ route('sa_posts_create') }}">Add Post</a>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="laravel_datatable_sa_post">
                            <thead class="thead-light">
                                <tr>
                                    <th scope="col" class="sort" data-sort="name">Thumb</th>
                                    <th scope="col" class="sort" data-sort="budget"></th>
                                    <th scope="col" class="sort" data-sort="likes"></th>
                                    <th scope="col" class="sort" data-sort="commnets"></th>
                                    <th scope="col"></th>
                                </tr>
                            </thead>
                            <tbody class="list">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <a class="dropdown-item"
                                                        href="{{ route('sa_post_edit', $post->id) }}">Edit</a>

                                                    <form onsubmit="return window.confirm('are you sure to delete?');"
                                                        action="{{ route('sa_post_delete', $post->id) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
