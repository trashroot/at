            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        <h3 style="display: inline-block;" class="mb-0">All Schools</h3>

                        <a style="float: right;" class="ml-auto btn btn-sm btn-info mr-4"
                            href="{{ route('sa_school_create') }}">Add School</a>
                    </div>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <a class="dropdown-item"
                                                        href="{{ route('sa_school_edit', $post->id) }}">Edit</a>

                                                    <form onsubmit="return window.confirm('are you sure to delete?');"
                                                        action="{{ route('sa_school_delete', $post->id) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
