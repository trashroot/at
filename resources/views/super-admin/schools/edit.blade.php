            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        <h3 class="mb-0">Update School</h3>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('sa_school_edit_save', $post->id) }}" autocomplete="off"
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group focused">
                                    ...
                                    <input required type="url" name="domain" id="input-d"
                                        ...
                                        placeholder="ex : http://nccu.yourathletestalk.com/" value="{{ $post->domain }}"
                                        autofocus="">
                                </div>
